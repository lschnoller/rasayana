            ...
            <?php if ($listing == 'default-tab') { ?>
                <div class="tab-content <?= $listing ?>" id="listing"> <!-- This is the target div. id must match the href of this div's tab -->	
                    ...
                    <table>
                        <thead>
                            <?php
                            echo list_head('admin_' . $me, 'Autor', 'author', 'Testimonio', 'quote_text', 'Profesión', 'pofession');
                            ?>
                        </thead>
                        ...
                        <tbody>
                            ...
                            if (is_array($list)) {
                                foreach ($list as $key => $val) {
                                    ...
                                    echo list_item($val['status'], $key, 'admin_' . $me, $val['author'], $val['quote_text'], $profession);
                                }
                            }
                            ?>							
                        </tbody>
