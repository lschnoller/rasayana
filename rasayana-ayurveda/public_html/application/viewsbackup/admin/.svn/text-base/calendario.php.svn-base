...
<table width="900" cellpadding="0" cellspacing="0" align="center">
  ...
  <tr class="list dark">
    ...
    <td><input type="text" name="event_date" value="<?php echo set_value('event_date',$values['event_date']); ?>" size="30" readonly="readonly">* <input type="button" onclick="displayCalendar(document.forms[0].event_date,'yyyy-mm-dd',this)" value="Select Date" /></td>
  </tr>
  <tr class="list dark">
