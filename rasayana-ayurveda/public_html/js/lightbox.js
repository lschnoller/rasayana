...
var Lightbox = Class.create({
	...
	_makeVisible : function makeVisible(){
		...
		alert(document.viewport.getScrollOffsets().top + document.viewport.getHeight());
		$("bg_fade").style.width = (document.viewport.getWidth() + document.viewport.getScrollOffsets().left) + 'px';
		$("bg_fade").style.height = (document.viewport.getHeight() + document.viewport.getScrollOffsets().top) + 'px';
