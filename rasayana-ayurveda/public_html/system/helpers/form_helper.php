...
if ( ! function_exists('form_upload'))
{
	function form_upload($obl = FALSE,$title ='',$data = '', $value = '', $extra = '',$desci=FALSE,$preview = '')
	{
		...
		if($desci)
			...
			$desci = '';
		if($preview !='')
			$preview = '<a href="'.$preview.'" rel="facebox">preview</a>';
		return '
			<p>
...
{
	function form_textarea($obl = FALSE,$title = '',$data = '', $value = '', $extra = '')
	{
		if($obl)
			$oblspan = '<span class="obl"> * </span>';
		else
...
{
	function form_dropdown($obl = FALSE,$title='',$name = '', $options = array(), $selected = array(), $extra = '')
	{
		if($obl)
			$oblspan = '<span class="obl"> * </span>';
		else
		...
		$form = '<select name="'.$name.'"'.$extra.$multiple." class=\"small-input\">\n";
		...
		foreach ($options as $key => $val)
		{
			...
			if (is_array($val))
			{
				...
				foreach ($val as $optgroup_key => $optgroup_val)
				{
					...
					$form .= '<option value="'.$optgroup_key.'" '.$sel.' '.set_select($name,$optgroup_key).'>'.(string) $optgroup_val."</option>\n";
				}
			...
			else
			{
				...
				$form .= '<option value="'.$key.'" '.set_select($name,$key,$sel).'>'.(string) $val."</option>\n";
			}
		}
